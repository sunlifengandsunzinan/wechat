...
function doSearch(){
 	...
 	var oForm = document.getElementById("fm_searchSupply"); 
	 oForm.submit(); 
...
<body >	
   ...
   <form  id="fm_searchSupply" action="<%=path %>/supplyDemandManager/doSearchSupply" name="fm_searchSupply" method="post">
