...
$.post("<%=path%>/supplyDemandManager/intFirCategory",
	      ...
	      $("#selFirCategory").find("option[id='${firSecCategory.fircategoryid}']").attr("selected",true);
	      selectProv('${firSecCategory.fircategoryid}');
	      $("#selFirCategory").find("option[id='${firSecCategory.seccategoryid}']").attr("selected",true);
		   });   
}
...
function loadProv(){
	$.post("<%=path%>/register/intProCity",
		      ...
		      if('${supplyDemandRegion.regionId}'=='${supplyDemandRegion.cityId}'){

		    	  $("#selProvince").find("option[id='${supplyDemandRegion.regionId}']").attr("selected",true);
		    	  selectCityList();
		    	  $("#selCity").find("option[id='${supplyDemandRegion.regionId}']").attr("selected",true);
		    	  $("#selCity").hide();
		      }else if('${supplyDemandRegion.cityName}'=="全省"){
			      $("#selProvince").find("option[id='${supplyDemandRegion.regionId}']").attr("selected",true);    
			      selectProvinve();
		      }else{
			      $("#selProvince").find("option[id='${supplyDemandRegion.regionId}']").attr("selected",true);    
			      selectCityList();
			      $("#selCity").find("option[id='${supplyDemandRegion.cityId}']").attr("selected",true);
		      }
...
function doSelect(){
	...
	function doAddSupplyDemand(){
		...
		if(company == ""){
	   	 ...
	   	 var url = "<%=path%>/supplyDemandManager/doModifySupplyDemand";
    ...
    <td width="904" height="300" align="left" valign="top"><table width="904" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
      <tr>
        <td width="902" height="500" align="center" valign="top" bgcolor="#f6f6f6"><table width="902" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td width="902" height="40" align="left" valign="middle" background="../images/hy_03.jpg" class="STYLE4">修改信息</td>
          </tr>
        </table>
        <form id="fm_doAddSupplyDemand" name="fm_doAddSupplyDemand" action="<%=path%>/supplyDemandManager/doModifySupplyDemand" method="post">   
                  ...
                  <td width="800" height="500" align="center" valign="top"><table width="800" border="0" cellspacing="0" cellpadding="0">
                     <tr style="display:none;">
						...
						<td width="68%" height="30" align="left" valign="middle">
							<input id="id" name="id" class="easyui-validatebox textbox" data-options="required:true" style="width: 180px; height: 20px;" value ="${supplyDemandInfo.id}"/>
						</td>
					</tr>		
                      <tr>
                        <td width="80" height="50" align="right" valign="middle">产品名称：</td>
                        <td colspan="2" align="left"><input id="company" name="company" type="text" data-options="required:true" style="width:410px; height:25px; line-height:25px; padding-left:5px;" value ="${supplyDemandInfo.name}"/></td>
                      ...
                      <tr>
                        ...
                        <td align="left"><input type="text" name="username" id="username" style="width:230px; height:25px; line-height:25px; padding-left:5px;" value ="${supplyDemandUser.username}"/></td>
                        <td colspan="2" align="left" style="padding-left:10px;">* 请填写产品相关联系人姓名</td>
                      </tr>
                      <tr>
                        <td height="50" align="right" valign="middle">联系电话：</td>
                        <td align="left"><input type="text" name="phone" id="phone" style="width:230px; height:25px; line-height:25px; padding-left:5px;" value ="${supplyDemandUser.phone}"/></td>
                    ...
                    <table width="800" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="720" align="left" valign="top" style="padding-top:10px;"><label>
                            <textarea name="desc" id=""desc"" cols="45" rows="5" style="width:650px; height:130px;">${supplyDemandInfo.desc}</textarea>
                          </label></td>
                        </tr>
                      </table>
                    <table width="800" border="0" cellspacing="0" cellpadding="0">
