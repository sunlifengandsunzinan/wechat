...
function toDetail(id){
	window.location="<%=path%>/supplyDemandManager/companyDetail?id="+id;
 	...
 	<form id="fm_selectSupplyOrder" action="<%=path %>/supplyDemandManager/doSearchDemandOrder" name="fm_selectSupplyOrder" method="post">
    ...
    <td width="1098" height="200" bgcolor="#ffffff"><table width="1098" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="1098" height="50"><table width="1098" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="110" height="25"><table width="110" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="40" height="50" align="center" valign="middle"><img src="../images/biao_01.jpg" width="13" height="15" /></td>
            ...
            <td width="988" align="left" valign="middle"><table width="988" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="200" height="50" id ="alcity"><table width="180" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="152" height="27" align="center" valign="middle" background="../images/bj_04.jpg" class="STYLE10" id="c" name ="c">${city}</td>
                      <td width="28"><a id ="deletecity" href="javascript:void(0)" onclick="removeCity();"><img src="../images/biao_05.jpg" width="28" height="27" border="0" /></a></td>
                    </tr>
                </table></td>
                <td width="160" id ="alsec"><table width="140" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="112" height="27" align="center" valign="middle" background="../images/bj_04.jpg" class="STYLE10" id="s" name ="s">${seccategory}</td>
                      <td width="28"><a id ="deletecategory" href='javascript:void(0)' onclick='removeSec();'><img src="../images/biao_05.jpg" width="28" height="27" border="0" /></a></td>
                    </tr>
                </table></td>
          ...
          <tr>
            <td height="1" colspan="2" background="../images/dian01.jpg"></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td height="50"><table width="1098" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="39" height="50" align="center" valign="top" style="padding-top:15px;"><img src="../images/biao_02.jpg" width="13" height="16" /></td>
	 ...
	 <c:forEach items="${list}" var="item" varStatus="status">  
		...
		<tr>
          ...
          <tr>
            <td height="1" colspan="3" align="center" valign="top" background="../images/dian01.jpg"></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td height="50"><table width="1098" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="110" height="50"><table width="110" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="40" height="50" align="center" valign="middle"><img src="../images/biao_04.jpg" width="14" height="14" /></td>
            ...
            <td width="578" align="left" valign="middle"><a href="javascript:void(0)" onclick="doSearch();"><img src="../images/an09.jpg" width="80" height="35" border="0" /></a></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#dfdadc" style="margin:0 auto;">
  <tr>
    <td width="1098" height="34" background="../images/bj_02.jpg" bgcolor="#f3f3f3"><table width="1098" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="150" height="34" align="center" valign="middle" background="../images/hx_01.jpg" class="STYLE10">供货服务信息</td>
        <td width="948">&nbsp;</td>
      </tr>
    </table></td>
  </tr>
        ...
        <td width="235" height="117" align="center" valign="top" bgcolor="#f9f8f8"><table width="235" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="120" align="center" valign="middle"><table width="120" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="120" height="120"><img src="../images/03.jpg" width="120" height="120" /></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="50" align="center" valign="middle"><table width="135" border="0" cellpadding="0" cellspacing="0" background="../images/bj_03.jpg">
              <tr>
