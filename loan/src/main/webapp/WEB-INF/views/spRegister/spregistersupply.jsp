			 ...
			 if(newpassword != confirmpassword){
				$.messager.alert('提示','您两次输入的新密码不一致.','info');
		    	 ...
		    	 var url = "<%=path%>/spRegister/doRegister";
			 		$('#fm_spregisterSupply').form('submit', {
			 			url : url,
    ...
    <table width="1440" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="320" align="center" valign="middle">
         <form id="fm_spregisterSupply" name="fm_spregisterSupply" action="<%=path%>/spRegister/doRegister" method="post"> 
          ...
          <tr style="display:none;">
            ...
            <tr>
              ...
              <td height="50" align="left" valign="middle"><input type="text" name="address" id="address" data-options="required:true" style="width:261px; height:27px; line-height:27px; padding-left:5px;" /></td>
               ...
               <tr>
              <td align="center" valign="middle" style="font-size:15px; color:#CCCCCC;">公司名称：</td>
              <td height="50" align="left" valign="middle"><input type="text" name="company" id="company" data-options="required:true" style="width:261px; height:27px; line-height:27px; padding-left:5px;" /></td>
            </tr>
                                  <tr>
                             <td align="center" valign="middle" style="font-size:15px; color:#CCCCCC;">公司描述：</td>
      ...
      <tr>
        <td height="113" align="center" valign="middle"><table width="1000" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="333" height="80" align="center" valign="middle"><span class="STYLE3">564,122</span><span class="STYLE2">供应信息</span></td>
              <td width="333" align="center" valign="middle"><span class="STYLE3">564,122</span><span class="STYLE2">需求信息</span></td>
              <td width="334" align="center" valign="middle"><span class="STYLE3">564,122</span><span class="STYLE2">成功洽谈</span></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
